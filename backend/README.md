...
## Project Structure
    ...
    ├── testapiautostoryboa_64289  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_64289`
...
2. Clone this repo and `cd testapiautostoryboa_64289`
